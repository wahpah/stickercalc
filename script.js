...
// SECRET MENU BUTTON - triggers secret calculation & stores result
...
menuButton.addEventListener("click", function() {
    ...
    // Doesn't change display, just resets for next phase
    clearCount = 0;
    revealArmed = false;
    revealUsed = false;
...
// When armed, first tap anywhere reveals the secret
